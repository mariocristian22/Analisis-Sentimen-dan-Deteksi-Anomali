...
# ── Halaman sesuai urutan metodologi PI ───────────────────
crawling_page       = st.Page("pages/Crawling.py",       title="Crawling",       icon="🔍")
...
if not st.session_state.started:
    ...
    @media (max-width: 600px) {
        .topbar { font-size: 17px; padding: 14px 20px; }
        .badge { font-size: 15px; padding: 9px 20px; }
        .hero-title { font-size: 36px; line-height: 1.2; }
        .hero-subtitle { font-size: 19px; margin-bottom: 16px; }
        .hero-desc { font-size: 16px; line-height: 1.7; margin-bottom: 14px; }
        .hero-desc-2 { font-size: 15px; line-height: 1.65; margin-bottom: 26px; }
        .hero { padding: 30px 20px; }
        .cta-button { padding: 15px 38px; font-size: 19px; }
        ...
        <div class="hero">
            ...
            <div class="hero-center">
                ...
                <div class="hero-desc-2">
                    Melalui aplikasi ini, pengguna dapat melakukan crawling data, melihat distribusi sentimen,
                    distribusi rating, hasil deteksi anomali, melakukan pengujian komentar secara manual,
                    serta membaca ringkasan hasil analisis dalam bentuk dashboard dan visualisasi data yang interaktif.
                </div>
