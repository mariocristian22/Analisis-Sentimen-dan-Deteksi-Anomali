...
if not st.session_state.started:
    ...
    /* Di layar sempit (HP/tablet), tombol tidak ditarik ke atas
       supaya tidak menabrak teks hero yang sudah lebih panjang
       karena word-wrap. */
    ...
    @media (max-width: 1024px) {
        ...
        .hero-desc-2 { font-size: 15px; line-height: 1.6; }
        .hero { padding: 40px 24px 90px 24px; min-height: auto; }
    }
    ...
    @media (max-width: 600px) {
        ...
        .hero-desc { font-size: 14px; line-height: 1.6; margin-bottom: 12px; }
        .hero-desc-2 { font-size: 13px; line-height: 1.5; }
        .hero { padding: 28px 16px 70px 16px; border-radius: 18px; }
